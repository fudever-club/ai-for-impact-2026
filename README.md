...
[![Vitest](https://img.shields.io/badge/Vitest-57%2F57_Pass-6E9F18?style=for-the-badge&logo=vitest&logoColor=white)](https://vitest.dev/)
...
[**Khám phá Sự kiện**](https://ai.impact.fptu.vn) · [**Sổ tay Thí sinh**](./public/docs/So_tay_thi_sinh_AI-for-Impact-2026.docx) · [**Quy chuẩn Kiến trúc**](./docs/ARCHITECTURE.md) · [**Về FU-DEVER**](#-về-đơn-vị-phát-triển--clb-lập-trình-fu-dever)
...
- 🛡️ **Kiểm định Chất lượng Nghiêm ngặt**: 57 unit tests bao phủ 100% logic ngày tháng, tính toàn vẹn SSOT, nội suy token, hợp đồng responsive di động và cấu trúc giải thưởng.
...
- 📦 **Static Export Siêu Nhẹ**: Tối ưu hóa bundle First Load JS chỉ 148 kB, tốc độ tải tức thì, dễ dàng triển khai trên mọi hạ tầng tĩnh (Cloudflare Pages, Vercel, GitHub Pages).
...
| :--- | :--- | :--- |
| **Framework** | [Next.js 13.5 App Router](https://nextjs.org/) (`output: 'export'`) | Nền tảng web tĩnh hiệu năng cao |
...
| **Kiểm thử** | [Vitest](https://vitest.dev/) (`vitest.config.mts`) | Chạy 57/57 unit tests tự động |
...
# Bước 3: Chạy toàn bộ 57 bài kiểm thử tự động
npm test
...
├── tests/                         # Vitest Test Suites (57 tests passed 100%)
